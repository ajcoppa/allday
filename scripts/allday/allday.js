...
var _templateObject58, _templateObject220;
var _templateObject59, _templateObject66, _templateObject75, _templateObject85, _templateObject96, _templateObject106, _templateObject116, _templateObject126, _templateObject136;
var _templateObject206, _templateObject2110;
function _taggedTemplateLiteral9(strings, raw) {
  return raw || (raw = strings.slice(0)), Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } }));
}
var minusMLItems = $items(_templateObject58 || (_templateObject58 = _taggedTemplateLiteral9(["nasty rat mask, Drowsy Sword, HOA regulation book, pocketwatch on a chain, security flashlight, Space Trip safety headphones, pine cone necklace, red badge, mushroom badge, water wings for babies, white earbuds, discarded bowtie"])));
function maxBase() {
  return "175 bonus June Cleaver, ".concat(garboValue($item(_templateObject220 || (_templateObject220 = _taggedTemplateLiteral9(["FunFunds\u2122"])))) / 20 + 5, " bonus lucky gold ring, 250 bonus Mr. Cheeng's spectacles, ").concat(0.4 * get("valueOfAdventure"), " bonus mafia thumb ring, 10 bonus tiny stillsuit");
}
function canDiet() {
  return (0, import_kolmafia17.myFullness)() < (0, import_kolmafia17.fullnessLimit)() || (0, import_kolmafia17.mySpleenUse)() < (0, import_kolmafia17.spleenLimit)() || (0, import_kolmafia17.myInebriety)() < (0, import_kolmafia17.inebrietyLimit)() || have($item(_templateObject59 || (_templateObject59 = _taggedTemplateLiteral9(["distention pill"])))) && !get("_distentionPillUsed") || have($item(_templateObject66 || (_templateObject66 = _taggedTemplateLiteral9(["synthetic dog hair pill"])))) && !get("_syntheticDogHairPillUsed") || have($item(_templateObject75 || (_templateObject75 = _taggedTemplateLiteral9(["designer sweatpants"])))) && get("_sweatOutSomeBoozeUsed") < 3 && get("sweat") >= 25 || have($item(_templateObject85 || (_templateObject85 = _taggedTemplateLiteral9(["mime army shotglass"])))) && !get("_mimeArmyShotglassUsed") || get("currentMojoFilters") < 3 && (0, import_kolmafia17.mallPrice)($item(_templateObject96 || (_templateObject96 = _taggedTemplateLiteral9(["mojo filter"])))) + (0, import_kolmafia17.mallPrice)($item(_templateObject106 || (_templateObject106 = _taggedTemplateLiteral9(["transdermal smoke patch"])))) < 2.5 * get("valueOfAdventure");
}
function stooperDrunk() {
  return (0, import_kolmafia17.myInebriety)() > (0, import_kolmafia17.inebrietyLimit)() || (0, import_kolmafia17.myInebriety)() === (0, import_kolmafia17.inebrietyLimit)() && (0, import_kolmafia17.myFamiliar)() === $familiar(_templateObject116 || (_templateObject116 = _taggedTemplateLiteral9(["Stooper"])));
}
function totallyDrunk() {
  return have($familiar(_templateObject126 || (_templateObject126 = _taggedTemplateLiteral9(["Stooper"])))) && (0, import_kolmafia17.myFamiliar)() !== $familiar(_templateObject136 || (_templateObject136 = _taggedTemplateLiteral9(["Stooper"]))) ? (0, import_kolmafia17.myInebriety)() > (0, import_kolmafia17.inebrietyLimit)() + 1 : (0, import_kolmafia17.myInebriety)() > (0, import_kolmafia17.inebrietyLimit)();
}
function doneAdventuring() {
  return !canDiet() && (0, import_kolmafia17.myAdventures)() === 0 || stooperDrunk();
}
var gardens2 = $items(_templateObject206 || (_templateObject206 = _taggedTemplateLiteral9(["packet of pumpkin seeds, Peppermint Pip Packet, packet of dragon's teeth, packet of beer seeds, packet of winter seeds, packet of thanksgarden seeds, packet of tall grass seeds, packet of mushroom spores"])));
function getGarden() {
  return gardens2.find(function(it) {
    return it.name in (0, import_kolmafia17.getCampground)();
  }) || $item(_templateObject2110 || (_templateObject2110 = _taggedTemplateLiteral9(["none"])));
}

// src/tasks/aftercore.ts
var _templateObject60, _templateObject221, _templateObject317, _templateObject416, _templateObject510, _templateObject67, _templateObject76, _templateObject86, _templateObject97, _templateObject107, _templateObject117, _templateObject127, _templateObject137, _templateObject146, _templateObject156, _templateObject166, _templateObject176, _templateObject186, _templateObject196, _templateObject207, _templateObject2111, _templateObject226, _templateObject236, _templateObject246, _templateObject256, _templateObject266, _templateObject276, _templateObject286, _templateObject296, _templateObject306, _templateObject318, _templateObject325, _templateObject335, _templateObject345, _templateObject355, _templateObject364, _templateObject374, _templateObject384, _templateObject394, _templateObject404, _templateObject417, _templateObject424, _templateObject434, _templateObject444, _templateObject454, _templateObject463, _templateObject473, _templateObject483, _templateObject493, _templateObject503, _templateObject512;
...
function AftercoreQuest() {
  return {
    ...
    tasks: [{
      ...
      name: "Harvest Garden",
      completed: function() {
        return getGarden() === $item(_templateObject221 || (_templateObject221 = _taggedTemplateLiteral10(["none"]))) || getGarden() === $item(_templateObject317 || (_templateObject317 = _taggedTemplateLiteral10(["packet of mushroom spores"]))) || (0, import_kolmafia18.getCampground)()[getGarden().name] === 0;
      },
      do: function() {
      ...
      name: "SIT Course",
      ready: function() {
        return have($item(_templateObject416 || (_templateObject416 = _taggedTemplateLiteral10(["S.I.T. Course Completion Certificate"]))));
      },
      completed: function() {
      ...
      post: function() {
        (0, import_kolmafia18.myAdventures)() === 0 && $effects(_templateObject137 || (_templateObject137 = _taggedTemplateLiteral10(["Power Ballad of the Arrowsmith, Stevedave's Shanty of Superiority, The Moxious Madrigal, The Magical Mojomuscular Melody, Aloysius' Antiphon of Aptitude, Ur-Kel's Aria of Annoyance"]))).filter(function(ef) {
          return have(ef);
        }).forEach(function(ef) {
          return uneffect(ef);
        });
      ...
      name: "Stooper",
      ready: function() {
        return (0, import_kolmafia18.myInebriety)() === (0, import_kolmafia18.inebrietyLimit)() && have($item(_templateObject146 || (_templateObject146 = _taggedTemplateLiteral10(["tiny stillsuit"])))) && get("familiarSweat") >= 300;
      },
      completed: function() {
        return !have($familiar(_templateObject156 || (_templateObject156 = _taggedTemplateLiteral10(["Stooper"])))) || stooperDrunk();
      },
      do: function() {
        (0, import_kolmafia18.useFamiliar)($familiar(_templateObject166 || (_templateObject166 = _taggedTemplateLiteral10(["Stooper"])))), (0, import_kolmafia18.cliExecute)("drink stillsuit distillate");
      }
    }, {
      name: "Barfing Drunk with Stooper",
      ready: function() {
        return stooperDrunk() && have($familiar(_templateObject176 || (_templateObject176 = _taggedTemplateLiteral10(["Stooper"])))) && !have($item(_templateObject186 || (_templateObject186 = _taggedTemplateLiteral10(["Drunkula's wineglass"]))));
      },
      completed: function() {
        return (0, import_kolmafia18.myAdventures)() === 0 || totallyDrunk();
      },
      acquire: [{
        item: $item(_templateObject196 || (_templateObject196 = _taggedTemplateLiteral10(["seal tooth"])))
      }],
      outfit: function() {
        return {
      ...
      do: $location(_templateObject226 || (_templateObject226 = _taggedTemplateLiteral10(["Barf Mountain"]))),
      combat: new CombatStrategy().macro(Macro.trySkill($skill(_templateObject236 || (_templateObject236 = _taggedTemplateLiteral10(["Curse of Weaksauce"])))), getTodaysHolidayWanderers()).macro(function() {
        return Macro.step("pickpocket").trySkill($skill(_templateObject246 || (_templateObject246 = _taggedTemplateLiteral10(["Bowl Straight Up"])))).trySkill($skill(_templateObject256 || (_templateObject256 = _taggedTemplateLiteral10(["Sing Along"])))).tryItem($item(_templateObject266 || (_templateObject266 = _taggedTemplateLiteral10(["porquoise-handled sixgun"])))).externalIf((0, import_kolmafia18.haveEquipped)($item(_templateObject276 || (_templateObject276 = _taggedTemplateLiteral10(["mafia pointer finger ring"])))), Macro.trySkill($skill(_templateObject286 || (_templateObject286 = _taggedTemplateLiteral10(["Furious Wallop"])))).trySkill($skill(_templateObject296 || (_templateObject296 = _taggedTemplateLiteral10(["Summer Siesta"])))).trySkill($skill(_templateObject306 || (_templateObject306 = _taggedTemplateLiteral10(["Throw Shield"])))).trySkill($skill(_templateObject318 || (_templateObject318 = _taggedTemplateLiteral10(["Precision Shot"]))))).attack().repeat();
      }),
      limit: {
        tries: 30
      }
      ...
      ready: function() {
        return have($item(_templateObject325 || (_templateObject325 = _taggedTemplateLiteral10(["Drunkula's wineglass"]))));
      },
      completed: function() {
        return totallyDrunk();
      },
      ...
      ready: function() {
        return have($item(_templateObject335 || (_templateObject335 = _taggedTemplateLiteral10(["Beach Comb"])))) || have($item(_templateObject345 || (_templateObject345 = _taggedTemplateLiteral10(["Map to Safety Shelter Grimace Prime"]))));
      },
      completed: function() {
        return totallyDrunk();
      },
      ...
      name: "Grimace Maps",
      completed: function() {
        return (0, import_kolmafia18.myAdventures)() === 0 || !have($item(_templateObject355 || (_templateObject355 = _taggedTemplateLiteral10(["Map to Safety Shelter Grimace Prime"]))));
      },
      effects: $effects(_templateObject364 || (_templateObject364 = _taggedTemplateLiteral10(["Transpondent"]))),
      choices: {
        536: function() {
          return (0, import_kolmafia18.availableAmount)($item(_templateObject374 || (_templateObject374 = _taggedTemplateLiteral10(["distention pill"])))) < (0, import_kolmafia18.availableAmount)($item(_templateObject384 || (_templateObject384 = _taggedTemplateLiteral10(["synthetic dog hair pill"])))) + (0, import_kolmafia18.availableAmount)($item(_templateObject394 || (_templateObject394 = _taggedTemplateLiteral10(["Map to Safety Shelter Grimace Prime"])))) ? 1 : 2;
        }
      },
      do: function() {
        return (0, import_kolmafia18.use)($item(_templateObject404 || (_templateObject404 = _taggedTemplateLiteral10(["Map to Safety Shelter Grimace Prime"]))));
      },
      limit: {
        tries: 30
      }
      ...
      ready: function() {
        return get("_stenchAirportToday") && (0, import_kolmafia18.itemAmount)($item(_templateObject417 || (_templateObject417 = _taggedTemplateLiteral10(["FunFunds\u2122"])))) >= 20;
      },
      completed: function() {
        return have($item(_templateObject424 || (_templateObject424 = _taggedTemplateLiteral10(["one-day ticket to Dinseylandfill"]))));
      },
      do: function() {
        return (0, import_kolmafia18.buy)($coinmaster(_templateObject434 || (_templateObject434 = _taggedTemplateLiteral10(["The Dinsey Company Store"]))), 1, $item(_templateObject444 || (_templateObject444 = _taggedTemplateLiteral10(["one-day ticket to Dinseylandfill"]))));
      },
      tracking: "Garbo"
    }, {
      name: "PvP",
      ...
      completed: function() {
        return $items(_templateObject454 || (_templateObject454 = _taggedTemplateLiteral10(["Deep Dish of Legend, Calzone of Legend, Pizza of Legend, one-day ticket to Dinseylandfill, borrowed time"]))).filter(function(it) {
          return have(it);
        }).length === 5;
      },
      do: function() {
        $items(_templateObject463 || (_templateObject463 = _taggedTemplateLiteral10(["one-day ticket to Dinseylandfill, borrowed time"]))).forEach(function(it) {
          have(it) || (0, import_kolmafia18.buy)(it);
        }), $items(_templateObject473 || (_templateObject473 = _taggedTemplateLiteral10(["Deep Dish of Legend, Calzone of Legend, Pizza of Legend"]))).forEach(function(it) {
      ...
      do: function() {
        ascend($path(_templateObject483 || (_templateObject483 = _taggedTemplateLiteral10(["Community Service"]))), $class(_templateObject493 || (_templateObject493 = _taggedTemplateLiteral10(["Sauceror"]))), Lifestyle.softcore, "opossum", $item(_templateObject503 || (_templateObject503 = _taggedTemplateLiteral10(["astral six-pack"]))), $item(_templateObject512 || (_templateObject512 = _taggedTemplateLiteral10(["astral pet sweater"])))), (0, import_kolmafia18.cliExecute)("refresh all");
      }
    }]
  };
}
...
var _templateObject61, _templateObject227, _templateObject319, _templateObject418, _templateObject511, _templateObject68, _templateObject77, _templateObject87, _templateObject98, _templateObject108, _templateObject118, _templateObject128, _templateObject138, _templateObject147, _templateObject157, _templateObject167, _templateObject177, _templateObject187, _templateObject197, _templateObject208, _templateObject2112, _templateObject228, _templateObject237, _templateObject247, _templateObject257, _templateObject267, _templateObject277, _templateObject287, _templateObject297, _templateObject307, _templateObject3110, _templateObject326, _templateObject336, _templateObject346, _templateObject356, _templateObject365, _templateObject375, _templateObject385, _templateObject395, _templateObject405, _templateObject419, _templateObject425, _templateObject435, _templateObject445, _templateObject455, _templateObject464, _templateObject474;
...
function CSQuests() {
  return [{
    ...
    tasks: [{
      ...
      do: function() {
        return (0, import_kolmafia19.use)($item(_templateObject319 || (_templateObject319 = _taggedTemplateLiteral11(["S.I.T. Course Completion Certificate"]))));
      }
    }, {
      name: "Break Stone",
      completed: function() {
      ...
      name: "Stillsuit Prep",
      completed: function() {
        return (0, import_kolmafia19.itemAmount)($item(_templateObject418 || (_templateObject418 = _taggedTemplateLiteral11(["tiny stillsuit"])))) === 0;
      },
      do: function() {
    ...
    tasks: [{
      ...
      prepare: function() {
        return uneffect($effect(_templateObject98 || (_templateObject98 = _taggedTemplateLiteral11(["Beaten Up"]))));
      },
      do: function() {
        return (0, import_kolmafia19.cliExecute)("garbo workshed=cmc");
      },
      post: function() {
        return $effects(_templateObject108 || (_templateObject108 = _taggedTemplateLiteral11(["Power Ballad of the Arrowsmith, Stevedave's Shanty of Superiority, The Moxious Madrigal, The Magical Mojomuscular Melody, Aloysius' Antiphon of Aptitude, Ur-Kel's Aria of Annoyance"]))).filter(function(ef) {
          return have(ef);
        }).forEach(function(ef) {
          return uneffect(ef);
        });
      ...
      name: "Turn in FunFunds",
      ready: function() {
        return get("_stenchAirportToday") && (0, import_kolmafia19.itemAmount)($item(_templateObject118 || (_templateObject118 = _taggedTemplateLiteral11(["FunFunds\u2122"])))) >= 20;
      },
      completed: function() {
        return have($item(_templateObject128 || (_templateObject128 = _taggedTemplateLiteral11(["one-day ticket to Dinseylandfill"]))));
      },
      do: function() {
        return (0, import_kolmafia19.buy)($coinmaster(_templateObject138 || (_templateObject138 = _taggedTemplateLiteral11(["The Dinsey Company Store"]))), 1, $item(_templateObject147 || (_templateObject147 = _taggedTemplateLiteral11(["one-day ticket to Dinseylandfill"]))));
      },
      tracking: "Garbo"
    }, {
      name: "PvP",
      ...
      name: "Stooper",
      ready: function() {
        return (0, import_kolmafia19.myInebriety)() === (0, import_kolmafia19.inebrietyLimit)() && have($item(_templateObject157 || (_templateObject157 = _taggedTemplateLiteral11(["tiny stillsuit"])))) && get("familiarSweat") >= 300;
      },
      completed: function() {
        return !have($familiar(_templateObject167 || (_templateObject167 = _taggedTemplateLiteral11(["Stooper"])))) || stooperDrunk();
      },
      do: function() {
        (0, import_kolmafia19.useFamiliar)($familiar(_templateObject177 || (_templateObject177 = _taggedTemplateLiteral11(["Stooper"])))), (0, import_kolmafia19.cliExecute)("drink stillsuit distillate");
      }
    }, {
      name: "Nightcap",
      ready: function() {
      ...
      name: "Barfing Drunk with Stooper",
      ready: function() {
        return stooperDrunk() && have($familiar(_templateObject187 || (_templateObject187 = _taggedTemplateLiteral11(["Stooper"])))) && !have($item(_templateObject197 || (_templateObject197 = _taggedTemplateLiteral11(["Drunkula's wineglass"]))));
      },
      completed: function() {
        return (0, import_kolmafia19.myAdventures)() === 0 || totallyDrunk();
      },
      acquire: [{
        item: $item(_templateObject208 || (_templateObject208 = _taggedTemplateLiteral11(["seal tooth"])))
      }],
      outfit: function() {
        return {
          familiar: $familiar(_templateObject2112 || (_templateObject2112 = _taggedTemplateLiteral11(["Stooper"]))),
          modifier: "".concat(maxBase(), ", 2.5 meat, 0.6 items")
        };
      },
      effects: $effects(_templateObject228 || (_templateObject228 = _taggedTemplateLiteral11(["How to Scam Tourists"]))),
      prepare: function() {
        (0, import_kolmafia19.restoreHp)(0.75 * (0, import_kolmafia19.myMaxhp)()), (0, import_kolmafia19.restoreMp)(20);
      },
      do: $location(_templateObject237 || (_templateObject237 = _taggedTemplateLiteral11(["Barf Mountain"]))),
      combat: new CombatStrategy().macro(Macro.trySkill($skill(_templateObject247 || (_templateObject247 = _taggedTemplateLiteral11(["Curse of Weaksauce"])))), getTodaysHolidayWanderers()).macro(function() {
        return Macro.step("pickpocket").trySkill($skill(_templateObject257 || (_templateObject257 = _taggedTemplateLiteral11(["Bowl Straight Up"])))).trySkill($skill(_templateObject267 || (_templateObject267 = _taggedTemplateLiteral11(["Sing Along"])))).tryItem($item(_templateObject277 || (_templateObject277 = _taggedTemplateLiteral11(["porquoise-handled sixgun"])))).externalIf((0, import_kolmafia19.haveEquipped)($item(_templateObject287 || (_templateObject287 = _taggedTemplateLiteral11(["mafia pointer finger ring"])))), Macro.trySkill($skill(_templateObject297 || (_templateObject297 = _taggedTemplateLiteral11(["Furious Wallop"])))).trySkill($skill(_templateObject307 || (_templateObject307 = _taggedTemplateLiteral11(["Summer Siesta"])))).trySkill($skill(_templateObject3110 || (_templateObject3110 = _taggedTemplateLiteral11(["Throw Shield"])))).trySkill($skill(_templateObject326 || (_templateObject326 = _taggedTemplateLiteral11(["Precision Shot"]))))).attack().repeat();
      }),
      limit: {
        tries: 30
      }
      ...
      name: "Nightcap (Wine Glass)",
      ready: function() {
        return have($item(_templateObject336 || (_templateObject336 = _taggedTemplateLiteral11(["Drunkula's wineglass"]))));
      },
      completed: function() {
        return totallyDrunk();
      },
      ...
      name: "Nightcap (Marginal)",
      ready: function() {
        return have($item(_templateObject346 || (_templateObject346 = _taggedTemplateLiteral11(["Beach Comb"])))) || have($item(_templateObject356 || (_templateObject356 = _taggedTemplateLiteral11(["Map to Safety Shelter Grimace Prime"]))));
      },
      completed: function() {
        return totallyDrunk();
      },
      ...
      name: "Grimace Maps",
      completed: function() {
        return (0, import_kolmafia19.myAdventures)() === 0 || !have($item(_templateObject365 || (_templateObject365 = _taggedTemplateLiteral11(["Map to Safety Shelter Grimace Prime"]))));
      },
      effects: $effects(_templateObject375 || (_templateObject375 = _taggedTemplateLiteral11(["Transpondent"]))),
      choices: {
        536: function() {
          return (0, import_kolmafia19.availableAmount)($item(_templateObject385 || (_templateObject385 = _taggedTemplateLiteral11(["distention pill"])))) < (0, import_kolmafia19.availableAmount)($item(_templateObject395 || (_templateObject395 = _taggedTemplateLiteral11(["synthetic dog hair pill"])))) + (0, import_kolmafia19.availableAmount)($item(_templateObject405 || (_templateObject405 = _taggedTemplateLiteral11(["Map to Safety Shelter Grimace Prime"])))) ? 1 : 2;
        }
      },
      do: function() {
        return (0, import_kolmafia19.use)($item(_templateObject419 || (_templateObject419 = _taggedTemplateLiteral11(["Map to Safety Shelter Grimace Prime"]))));
      },
      limit: {
        tries: 30
      }
      ...
      name: "Pajamas",
      completed: function() {
        return have($item(_templateObject425 || (_templateObject425 = _taggedTemplateLiteral11(["burning cape"]))));
      },
      acquire: [{
        item: $item(_templateObject435 || (_templateObject435 = _taggedTemplateLiteral11(["clockwork maid"]))),
        price: 7 * get("valueOfAdventure"),
        optional: !0
      }, {
        item: $item(_templateObject445 || (_templateObject445 = _taggedTemplateLiteral11(["burning cape"])))
      }],
      do: function() {
        have($item(_templateObject455 || (_templateObject455 = _taggedTemplateLiteral11(["clockwork maid"])))) && (0, import_kolmafia19.use)($item(_templateObject464 || (_templateObject464 = _taggedTemplateLiteral11(["clockwork maid"]))));
      },
      outfit: function() {
        return {
          familiar: $familiars(_templateObject474 || (_templateObject474 = _taggedTemplateLiteral11(["Trick-or-Treating Tot, Left-Hand Man, Disembodied Hand, Grey Goose"]))).find(function(fam) {
            return have(fam);
          }),
